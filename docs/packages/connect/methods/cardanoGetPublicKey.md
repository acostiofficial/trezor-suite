...
-   `suppressBackupWarning` - _optional_ `boolean` By default, this method will send a postMessage to show a warning if the wallet does not have a backup. This option suppresses the message.
